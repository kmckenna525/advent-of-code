...
#Poison -> Magic Missile -> Recharge -> Poison -> Shield -> Recharge -> Poison -> Drain
# instead of input file, hardcoding
boss = Player(51, 9, 0)
player = Player(49, 0, 0, 500) 
gamestate = GameState(player.hp - 1, player.mana, player.armor, boss.hp)# start with -1 health for hardmode
